package leetcode.solved.categorized.dp.kadanes;

class P918MaximumSumCircularSubarray {
    public static void main(String[] args) {
        System.out.println("Max sub array sum for circular array: " + maxSubarraySumCircular(new int[]{
                1, -6, -7, 4}));
    }

    // This was a hard problem for me, even though I knew that Kadane's algorithm would be used, I could not get the exact trick.
