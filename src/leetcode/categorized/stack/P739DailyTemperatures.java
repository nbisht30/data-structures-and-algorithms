...
class P739DailyTemperatures {
    ...
    // TIME: 28 mins
    // COMMENTS: Could solve myself even though I took more time, still struggling in some stack problems. Last time took a lot more time and went with incorrect approach first initially which was n^2
    class SecondAttempt {
