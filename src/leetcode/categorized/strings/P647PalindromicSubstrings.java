...
class P647PalindromicSubstrings {
    ...
    // 2. Expand from middle approach O(n^2)
    /*
    INTUITION: https://leetcode.com/problems/palindromic-substrings/discuss/884357/EXPLANATION-or-Expand-form-middle-approach
    This is the fastest algo for this problem, even faster than the dynamic programming algo)
    ...
    // 3. DP approach(O(n^2) space and time complexity - Slower than expand from middle)
