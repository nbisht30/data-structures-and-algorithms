...
public class P49GroupAnagrams {
    ...
    // MYSELF
    // TIME: 45 mins(Could have solved in 12 mins if not for figuring out that prime numbers can be used)
    // INTUITION: Get a unique id for each anagram and put all anagrams mapping to their ids in a map,
